...
<div class="main-header">
    ...
    <p>Tác giả: Bàn Thị Huyền - Trường Tiểu học Hùng An - ĐT: 0961498931</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Bàn Thị Huyền - Trường Tiểu học Hùng A - ĐT: 0961498931</div>", unsafe_allow_html=True)
